...
namespace ASCOM.OpenFocuser{
    ...
    public class Config
    {
        //public static string XmlPresetsLocation = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), ASCOM.OpenFocuser.Focuser.s_csDriverID + @"\Presets.xml");
        ...
        {
            this._Profile.WriteValue(ASCOM.OpenFocuser.Focuser.s_csDriverID, key, value);
        }
        ...
        {
            return this._Profile.GetValue(ASCOM.OpenFocuser.Focuser.s_csDriverID, key);
        }
